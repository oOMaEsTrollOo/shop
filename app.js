...
let brandBlack = document.querySelector(".black");
let productBlack1 = document.querySelector(".product__black-1")
let productItem1 = document.querySelector(".products__item-1")
let productBlack2 = document.querySelector(".product__black-2")
let productItem2 = document.querySelector(".products__item-2")
let productBlack3 = document.querySelector(".product__black-3")
let productItem3 = document.querySelector(".products__item-3")
let productBlack4 = document.querySelector(".product__black-4")
let productItem4 = document.querySelector(".products__item-4")
let productBlack5 = document.querySelector(".product__black-5")
let productItem5 = document.querySelector(".products__item-5")
let productBlack6 = document.querySelector(".product__black-6")
let productItem6 = document.querySelector(".products__item-6")
let gostButton1 = document.querySelector(".ghost-button-1")
let gostButton2 = document.querySelector(".ghost-button-2")
let gostButton3 = document.querySelector(".ghost-button-3")
let gostButton4 = document.querySelector(".ghost-button-4")
let gostButton5 = document.querySelector(".ghost-button-5")
let gostButton6 = document.querySelector(".ghost-button-6")
